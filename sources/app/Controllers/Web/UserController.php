...
class UserController extends WebController
{
    ...
    public function index()
    {
        try {
            ...
            if ($this->isMethod('GET')) {
                $this->handleSuccessJsonResponse($user);
                ...
                if ($user = $user_model->update($data, $user['id'])) {
                    $this->handleSuccessJsonResponse($user);
                } else {
    ...
    public function refreshToken()
    {
        try {
            ...
            $user = JWTAuth::getUser();
            $token = JWTAuth::generateToken($user);
            $this->handleSuccessJsonResponse(['token' => $token], 'Refresh token sucesss!');
        } catch (Exception $e) {
            $this->handleExceptionJsonResponse($e);
        }
    }
